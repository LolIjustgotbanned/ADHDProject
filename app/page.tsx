...
// A Server Component with no client or data dependencies of its own (every
// route renders per request via the root layout's force-dynamic). Both
// links lead to /login (Clerk); signed-in visitors get bounced from there
// into /app by Clerk's own redirect handling.
const features = [
  {
